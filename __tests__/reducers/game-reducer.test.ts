...
describe("gameReducer", () => {
  describe("clean_up", () => {
    test("should clean up unused tiles after two tiles get merged together", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [0, 3], value: 2 };
  ...
  describe("create_tile", () => {
    ...
    test("should append tile id to the tide model", () => {
      const tile: Tile = { position: [0, 0], value: 2 };
      const { result } = renderHook(() =>
        useReducer(gameReducer, initialState)
      );
  ...
  describe("move_up", () => {
    test("should move tiles to the top of the board", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
    ...
    test("should stack tiles with the same values on top of each other", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [0, 3], value: 2 };
    ...
    test("should merge tiles with the same values", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [0, 3], value: 2 };
    ...
    test("should keep hasChanged falsy if no tile changed position or value", () => {
      const tile1: Tile = { position: [0, 0], value: 4 };
      const tile2: Tile = { position: [0, 1], value: 2 };
  ...
  describe("move_down", () => {
    test("should move tiles to the bottom of the board", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [1, 3], value: 2 };
    ...
    test("should keep hasChanged falsy if no tile changed position or value", () => {
      const tile1: Tile = { position: [0, 3], value: 2 };
      const tile2: Tile = { position: [1, 3], value: 2 };
    ...
    test("should keep the original order of tiles (regression test)", () => {
      const tile1: Tile = { position: [0, 1], value: 4 };
      const tile2: Tile = { position: [0, 3], value: 2 };
  ...
  describe("move_left", () => {
    test("should move tiles to the left side of the board", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [1, 3], value: 2 };
    ...
    test("should stack tiles with the same values on top of each other", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [3, 1], value: 2 };
    ...
    test("should keep hasChanged falsy if no tile changed position or value", () => {
      const tile1: Tile = { position: [0, 0], value: 2 };
      const tile2: Tile = { position: [0, 1], value: 2 };
  ...
  describe("move_right", () => {
    test("should move tiles to the right side of the board", () => {
      const tile1: Tile = { position: [0, 1], value: 2 };
      const tile2: Tile = { position: [1, 3], value: 2 };
    ...
    test("should keep hasChanged falsy if no tile changed position or value", () => {
      const tile1: Tile = { position: [3, 0], value: 2 };
      const tile2: Tile = { position: [3, 1], value: 2 };
